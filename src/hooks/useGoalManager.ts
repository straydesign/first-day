...
export function useGoalManager(onLogout: () => Promise<void>): UseGoalManagerReturn {
  ...
  }, [goalData, currentGoalId, generatePlan]);
  ...
  }, [selectedDay, planData?.startDate, progress, currentGoalId]);
