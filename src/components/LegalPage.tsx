...
function TermsContent() {
  return (
    <>
      ...
      <h2 className="text-xl font-semibold tracking-[-0.01em] text-white">1. Acceptance of Terms</h2>
      ...
      <h2 className="text-xl font-semibold tracking-[-0.01em] text-white">2. Description of Service</h2>
      ...
      <h2 className="text-xl font-semibold tracking-[-0.01em] text-white">3. User Accounts</h2>
      ...
      <h2 className="text-xl font-semibold tracking-[-0.01em] text-white">4. AI-Generated Content</h2>
      ...
      <h2 className="text-xl font-semibold tracking-[-0.01em] text-white">5. Content Ownership</h2>
      ...
      <h2 className="text-xl font-semibold tracking-[-0.01em] text-white">6. Acceptable Use</h2>
      ...
      <h2 className="text-xl font-semibold tracking-[-0.01em] text-white">7. Service Availability</h2>
      ...
      <h2 className="text-xl font-semibold tracking-[-0.01em] text-white">8. Account Termination</h2>
      <p className="text-white/70 leading-relaxed">You may delete your account at any time through the Settings page. We may suspend or terminate accounts that violate these terms. Upon termination, your data will be deleted in accordance with our Privacy Policy.</p>

      <h2 className="text-xl font-semibold tracking-[-0.01em] text-white">9. Limitation of Liability</h2>
      ...
      <h2 className="text-xl font-semibold tracking-[-0.01em] text-white">10. Changes to Terms</h2>
      ...
      <h2 className="text-xl font-semibold tracking-[-0.01em] text-white">11. Contact</h2>
