...
export default function Aurora({ colorStops = ['#FFE633', '#FF2D55', '#5227FF'] }: AuroraProps) {
  ...
  if (!mounted) {
    return <div className="w-full h-full bg-gradient-to-br from-[#060B18] via-[#1A0A5E] to-[#060B18]" />;
  }

  return (
    <div className="w-full h-full relative overflow-hidden bg-gradient-to-br from-[#060B18] via-[#1A0A5E] to-[#060B18]">
