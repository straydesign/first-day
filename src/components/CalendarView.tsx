        ...
        <div className="max-w-7xl mx-auto space-y-4 md:space-y-8">
          ...
          >
            ...
            {goalTitle && (<div className="text-center">
              ...
              {engagement?.isAtRisk && (
                <div className="mb-3 mx-auto max-w-md bg-[#1A0A5E] border border-coral-500/40 clip-tile-c px-4 py-2 flex items-center gap-2 animate-pulse">
                ...
                <MosaicCard seed={weekIndex} tileVariant={(["a", "b", "c", "d"] as const)[weekIndex % 4]} className={`p-3 md:p-6 transition-smooth ${week.isUnlocked ? 'backdrop-blur-sm' : 'opacity-60 cursor-not-allowed'}`}>
                  {week.isUnlocked ? (
                    <div className="space-y-3 md:space-y-4">
                      {week.weeklyBook && (
                        <div className="bg-gradient-to-br from-[#1A0A5E] to-[#1A0A5E] clip-tile-b border-2 border-yellow-600/30 overflow-hidden">
