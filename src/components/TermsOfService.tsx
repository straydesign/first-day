      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 pt-8 pb-6 md:pb-12 flex-1">
        <Panel contentClassName="p-6 md:p-8">
          <div className="prose prose-invert max-w-none space-y-6" style={{ fontFamily: FONT }}>
            ...
            <p className="text-white/70 leading-relaxed">First Day is a goal achievement platform that uses AI to generate personalized 30-day plans with daily activities, resource recommendations, and progress tracking. Plans are tailored to your stated goals, experience level, and preferences.</p>
