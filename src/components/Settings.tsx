  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="mb-8">
          <h1 className="text-slate-800 mb-2">Account Settings</h1>
          <p className="text-cyan-700">Manage your account and data preferences</p>
        </div>
        <div className="bg-white/80 backdrop-blur-sm border border-gray-200 rounded-xl p-6 mb-6 shadow-lg">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-slate-800">Account Information</h2>
          </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm border border-gray-200 rounded-xl p-6 mb-6 shadow-lg">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-full bg-lime-100 border border-lime-300 flex items-center justify-center"><Shield className="w-5 h-5 text-lime-600" /></div>
            <h2 className="text-slate-800">Privacy & Data</h2>
          </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm border border-gray-200 rounded-xl p-6 mb-6 shadow-lg">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-slate-800">Email Notifications</h2>
          </div>
          <div className="text-gray-700 text-sm space-y-2 mb-4">
            <p>Daily reminder emails are automatically sent based on your goal&apos;s preferred time slot.</p>
          </div>
          <Button onClick={handleSendTestEmail} disabled={isSendingTestEmail} variant="outline" className="border-2 border-coral-600 text-coral-600 hover:bg-coral-50 transition-smooth bg-white">
        ...
        <div className="bg-red-50 backdrop-blur-sm border border-red-200 rounded-xl p-6 shadow-lg">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-slate-800">Danger Zone</h2>
          </div>
          ...
          <AlertDialog>
            <AlertDialogTrigger asChild>
              <Button variant="outline" className="border-red-400 text-red-600 hover:bg-red-100 hover:text-red-700 bg-white"><Trash2 className="w-4 h-4 mr-2" />Delete My Account</Button>
            </AlertDialogTrigger>
            <AlertDialogContent className="bg-white border border-gray-200">
              ...
              <div className="my-4">
                ...
                <input type="text" value={confirmText} onChange={(e) => setConfirmText(e.target.value)} className="w-full px-3 py-2 bg-white border border-gray-300 rounded-md text-gray-900 focus:outline-none focus:ring-2 focus:ring-red-500" placeholder="Type DELETE" />
              </div>
              <AlertDialogFooter>
                <AlertDialogCancel onClick={() => setConfirmText("")} className="bg-white border-2 border-coral-600 text-coral-600 hover:bg-coral-50">Cancel</AlertDialogCancel>
