...
export function Settings({ accessToken, userId, userEmail, onBack, onDeleteSuccess }: SettingsProps) {
  ...
  return (
    <div className="min-h-screen bg-[#0F1B3A] relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 py-6 md:py-12">
        ...
        <MosaicCard seed={1} className="p-4 md:p-6 mb-4 md:mb-6 backdrop-blur-sm">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 clip-diamond bg-[#2437A6] border border-white/20 flex items-center justify-center"><User className="w-5 h-5 text-white" /></div>
        ...
        <MosaicCard seed={2} className="p-4 md:p-6 mb-4 md:mb-6 backdrop-blur-sm">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 clip-diamond bg-[#2437A6] border border-white/20 flex items-center justify-center"><Shield className="w-5 h-5 text-white" /></div>
        ...
        <MosaicCard seed={3} className="p-4 md:p-6 mb-4 md:mb-6 backdrop-blur-sm">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 clip-diamond bg-[#2437A6] border border-white/20 flex items-center justify-center"><Bell className="w-5 h-5 text-white" /></div>
        ...
        <MosaicCard seed={4} className="p-4 md:p-6 bg-red-950/30 backdrop-blur-sm">
          ...
          <AlertDialog>
            <AlertDialogTrigger asChild>
              <Button variant="outline" className="border-red-400 text-red-600 hover:bg-red-950/50 hover:text-red-400 bg-[#0F1B3A] transition-smooth hover:scale-105"><Trash2 className="w-4 h-4 mr-2" />Delete My Account</Button>
            </AlertDialogTrigger>
            <AlertDialogContent className="bg-[#0F1B3A] border border-white/10">
              <AlertDialogHeader>
              ...
              <div className="my-4">
                ...
                <Input type="text" value={confirmText} onChange={(e) => setConfirmText(e.target.value)} className="bg-[#0F1B3A] border-white/10 text-white focus:ring-2 focus:ring-red-500" placeholder="Type DELETE" />
              </div>
              <AlertDialogFooter>
                <AlertDialogCancel onClick={() => setConfirmText("")} className="bg-[#0F1B3A] border-2 border-white/10 text-white/80 hover:bg-white/10">Cancel</AlertDialogCancel>
