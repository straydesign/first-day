        ...
        <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
          ...
          <SheetContent side="right" className="w-[168px] backdrop-blur-xl border-l-2 border-white/10 pt-12">
            ...
            <nav className="flex flex-col gap-2 px-3">
              <Button onClick={() => setMobileMenuOpen(false)} variant="outline" size="sm" className="justify-start bg-[#1A0A5E] hover:bg-white/10 text-white border-white/10 text-sm py-2"><Target className="w-4 h-4 mr-2" />My Goals</Button>
