...
export function DayOneLogo({ className = "", width = 300, height = 150, showTagline = true }: DayOneLogoProps) {
  return (
    <div className={`flex flex-col items-center gap-2 ${className}`}>
      <svg width={width} height={height} viewBox="0 0 400 200" fill="none" xmlns="http://www.w3.org/2000/svg" className="drop-shadow-lg" data-logo="day-one">
        <g transform="translate(200, 80)">
          <circle cx="0" cy="-15" r="22" fill="url(#gradient2)" />
          <path d="M -105 40 L -87 10 L -70 40 L -35 -10 L 0 40 L 35 -10 L 70 40 L 87 10 L 105 40 Z" fill="url(#mountainGradient)" stroke="#0284c7" strokeWidth="2" strokeLinejoin="miter" />
        ...
        <text x="200" y="155" fontSize="42" fontWeight="900" textAnchor="middle" fill="#0284c7" letterSpacing="-1">FIRST DAY</text>
        {showTagline && (
          <text x="200" y="180" fontSize="21" fontWeight="600" textAnchor="middle" fill="#64748B" letterSpacing="-0.5">of the rest of your life</text>
        )}
        <defs>
