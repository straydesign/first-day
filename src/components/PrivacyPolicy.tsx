...
export function PrivacyPolicy({ onBack, onNavigate }: PrivacyPolicyProps) {
  return (
    <div className="min-h-screen relative flex flex-col">
      <VoronoiMosaic seed={3221} tileCount={80} margin={6} gap={3} palette={PANEL_DARK_PALETTE} className="fixed inset-0 w-full h-full pointer-events-none" />
      <div className="relative z-10 max-w-4xl mx-auto px-4 pt-[84px] pb-6 md:pb-12 flex-1">
