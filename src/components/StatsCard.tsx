...
export function StatsCard({ engagement }: StatsCardProps) {
  ...
  return (
    <div className="grid grid-cols-2 gap-3">
      <div className="relative backdrop-blur-sm clip-tile-a p-3 border border-white/15 overflow-hidden bg-[#0B132B]">
      ...
      <div className="relative backdrop-blur-sm clip-tile-b p-3 border border-white/15 overflow-hidden bg-[#0B132B]">
      ...
      <div className="relative backdrop-blur-sm clip-tile-c p-3 border border-white/15 overflow-hidden bg-[#0B132B]">
      ...
      <div className="relative backdrop-blur-sm clip-tile-d p-3 border border-white/15 overflow-hidden bg-[#0B132B]">
