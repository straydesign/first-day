...
export function StatsCard({ engagement }: StatsCardProps) {
  ...
  return (
    <div className="grid grid-cols-2 gap-3">
      <div className="relative backdrop-blur-sm clip-tile-a p-3 border border-white/15 overflow-hidden bg-[#0F1B3A]">
        <VoronoiMosaic seed={100} tileCount={20} margin={4} gap={2} className="absolute inset-0 w-full h-full" />
        <div className="absolute inset-0 bg-[#0F1B3A]/45 z-[1]" />
      ...
      <div className="relative backdrop-blur-sm clip-tile-b p-3 border border-white/15 overflow-hidden bg-[#0F1B3A]">
      ...
      <div className="relative backdrop-blur-sm clip-tile-c p-3 border border-white/15 overflow-hidden bg-[#0F1B3A]">
      ...
      <div className="relative backdrop-blur-sm clip-tile-d p-3 border border-white/15 overflow-hidden bg-[#0F1B3A]">
