    ...
    <div className="space-y-2">
      {days.map((day) => {
        ...
        const badgeBg = isCompleted
          ? "bg-[#FFD166] text-[#0B132B]"
          : day.isToday
            ? "bg-white/20 text-white font-bold"
            : isPast && !isCompleted
              ? "bg-coral-400 text-white"
              : "bg-[#3A0CA3] text-white/80";
        ...
        return (
          <button
            ...
            className={`w-full bg-[#0B132B]/80 backdrop-blur-sm clip-tile-c border-l-4 ${borderColor} p-3 md:p-4 flex items-center gap-3 md:gap-4 transition-smooth hover:bg-white/10 active:scale-[0.98] md:hover:scale-[1.01] border border-white/10`}
          >
            <div
